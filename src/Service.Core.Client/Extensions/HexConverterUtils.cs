...
namespace Service.Core.Client.Extensions
{
	public static class HexConverterUtils
	{
		...
		private static readonly Dictionary<char, byte> FirstByte = new()
		{
			['0'] = 0,
			['1'] = 16,
			['2'] = 32,
		...
		private static readonly Dictionary<char, byte> SecondByte = new()
		{
			['0'] = 0,
			['1'] = 1,
			['2'] = 2,
		...
		{
			var chArray1 = new char[bytes.Length * 2];
			var num1 = 0;
